...
After running and syncing your Sequencer node, You can go through [Get Role](https://github.com/Lifeofrebirth/aztecnode/blob/main/README.md#get-apprentice-discord-role) step.
...
* For more detailed steps, return to [Step 9: Run Sequencer Node](https://github.com/Lifeofrebirth/aztecnode/blob/main/README.md#9-run-sequencer-node) to re-run your node.
